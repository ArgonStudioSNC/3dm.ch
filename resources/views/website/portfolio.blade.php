...
<div id='home-fullscreen' data-img="{{ URL::asset('/media/renders/render-dorfkern-ipsach-ipsach-rollimarchiniarchitectessarl-2019@2560.jpg') }}" class="d-none d-sm-flex justify-content-center">
    @php
    ...
    <div id='ecole-neirivue' class='portfolio-bordered'> {{--Donner un id au projet--}}
        <div class="d-flex flex-wrap flex-column flex-sm-row">
            <picture class="flex-child">
                ...
                <img class="img-fluid" src="{{ asset('/media/renders/render-construction-nouvelle-ecole-neirivue-frontal-bbharchitectes-2019@640.jpg') }}" alt='Rendu frontal de la nouvelle école de Neirivue, projet réalisé par BBH Architectes'> {{--Compléter le chemin source @640x et texte alternatif--}}
            </picture>
            <picture class="flex-child">
                ...
                <img class="img-fluid" src="{{ asset('/media/renders/render-construction-nouvelle-ecole-neirivue-place-bbharchitectes-2019@640.jpg') }}" alt='Rendu de la place de la nouvelle école de Neirivue, projet réalisé par BBH Architectes'> {{--Compléter le chemin source @640x et texte alternatif--}}
            </picture>
        </div>
    ...
    <div id='mattenstrasse' class='portfolio-bordered'> {{--Donner un id au projet--}}
        <div class="d-flex flex-wrap flex-column flex-sm-row">
            <picture class="flex-child">
                ...
                <img class="img-fluid" src="{{ asset('/media/renders/render-allebruhlmattenstresse-bienne-exterieur-bartbuchhoferarchitektenag-2019@640.jpg') }}" alt='Rendu extérieur d Allee-/ Brühl-/ Mattenstrasse à Bienne, projet réalisé par Bart & Buchhofer Architekten AG'> {{--Compléter le chemin source @640x et texte alternatif--}}
            </picture>
            <picture class="flex-child">
                ...
                <img class="img-fluid" src="{{ asset('/media/renders/render-allebruhlmattenstresse-bienne-interieur-bartbuchhoferarchitektenag-2019@640.jpg') }}" alt='Rendu intérieur d Allee-/ Brühl-/ Mattenstrasse à Bienne, projet réalisé par Bart & Buchhofer Architekten AG'> {{--Compléter le chemin source @640x et texte alternatif--}}
            </picture>
        </div>
        <div class='legend'style="background-color: var(--light-brown);">
    ...
    <div id='allschwil' class='portfolio-bordered'> {{--Donner un id au projet--}}
        <div class="d-flex flex-wrap flex-column flex-sm-row">
            <picture class="flex-child">
                ...
                <img class="img-fluid" src="{{ asset('/media/renders/render-wegmatten-allschwil-interieur-p1-lvpharchitectessarlbricks-2019@640.jpg') }}" alt='Rendu du point de vue 1 intérieur du projet Wegmatten à Allschwil , projet réalisé par LVPH Architectes Sàrl + Bricks'> {{--Compléter le chemin source @640x et texte alternatif--}}
            </picture>
            <picture class="flex-child">
                ...
                <img class="img-fluid" src="{{ asset('/media/renders/render-wegmatten-allschwil-exterieur-p1-lvpharchitectessarlbricks-2019@640.jpg') }}" alt='Rendu du point de vue 1 extérieur du projet Wegmatten à Allschwil, projet réalisé par LVPH Architectes Sàrl + Bricks'> {{--Compléter le chemin source @640x et texte alternatif--}}
            </picture>
        </div>
        <div class="d-flex flex-wrap flex-column flex-sm-row">
            <picture class="flex-child">
                ...
                <img class="img-fluid" src="{{ asset('/media/renders/render-wegmatten-allschwil-interieur-p2-lvpharchitectessarlbricks-2019@640.jpg') }}" alt='Rendu du point de vue 2 intérieur du projet Wegmatten à Allschwil, projet réalisé par LVPH Architectes Sàrl + Bricks'> {{--Compléter le chemin source @640x et texte alternatif--}}
            </picture>
            <picture class="flex-child">
                ...
                <img class="img-fluid" src="{{ asset('/media/renders/render-wegmatten-allschwil-exterieur-p2-lvpharchitectessarlbricks-2019@640.jpg') }}" alt='Rendu du point de vue 2 extérieur du projet Wegmatten à Allschwil, projet réalisé par LVPH Architectes Sàrl + Bricks'> {{--Compléter le chemin source @640x et texte alternatif--}}
            </picture>
        </div>
        <div class='legend'style="background-color: var(--light-brown);">
    ...
    <div id='hes-so valais' class='portfolio-bordered'> {{--Donner un id au projet--}}
        <div class="d-flex flex-wrap flex-column flex-sm-row">
            <picture class="flex-child">
                ...
                <img class="img-fluid" src="{{ asset('/media/renders/render-he-so-valais-sion-exterieur-chappuisarchitectessa-2019@640.jpg') }}" alt='Rendu extérieur de la haute école spécialisée de Suisse occidentale à Sion, projet réalisé par Chappuis Architectes'> {{--Compléter le chemin source @640x et texte alternatif--}}
            </picture>
            <picture class="flex-child">
                ...
                <img class="img-fluid" src="{{ asset('/media/renders/render-he-so-valais-sion-interieur-chappuisarchitectessa-2019@640.jpg') }}" alt='Rendu intérieur de la haute école spécialisée de Suisse occidentale à Sion , projet réalisé par Chappuis Architectes'> {{--Compléter le chemin source @640x et texte alternatif--}}
            </picture>
        </div>
        <div class='legend'style="background-color: var(--light-brown);">
    ...
    <div id='les hutins' class='portfolio-bordered'> {{--Donner un id au projet--}}
        <div class="d-flex flex-wrap flex-column flex-sm-row">
            <picture class="flex-child">
                ...
                <img class="img-fluid" src="{{ asset('/media/renders/render-les-huttins-confignon-bunqarchitectes-exterieur-p2-2019@640.jpg') }}" alt='Rendu extérieur du point de vue 2 des Hutins à Confignon, projet réalisé par Bunq Architectes SA'> {{--Compléter le chemin source @640x et texte alternatif--}}
            </picture>
            <picture class="flex-child">
                ...
                <img class="img-fluid" src="{{ asset('/media/renders/render-les-huttins-confignon-bunqarchitectes-exterieur-p1-2019@640.jpg') }}" alt='Rendu extérieur du point de vue 1 des Hutins à Confignon , projet réalisé par Bunq Architectes SA'> {{--Compléter le chemin source @640x et texte alternatif--}}
            </picture>
        </div>
        <div class='legend'style="background-color: var(--light-brown);">
    ...
    <div id='gare cff' class='portfolio-bordered'> {{--Donner un id au projet--}}
        <div class="d-flex flex-wrap flex-column flex-sm-row">
            <picture class="flex-child">
                ...
                <img class="img-fluid" src="{{ asset('/media/renders/render-gare-cff-bex-iubengineeringsa-2019@640.jpg') }}" alt='Rendu extérieur du point de vue 1 de la gare de Bex, projet réalisé par CFF SA + IUB Engineering SA'> {{--Compléter le chemin source @640x et texte alternatif--}}
            </picture>
            <picture class="flex-child">
                ...
                <img class="img-fluid" src="{{ asset('/media/renders/render-gare-cff-bex-p2-iubengineeringsa-2019@640.jpg') }}" alt='Rendu extérieur du point de vue 2 de la gare de Bex, projet réalisé par CFF SA + IUB Engineering SA'> {{--Compléter le chemin source @640x et texte alternatif--}}
            </picture>
        </div>
        <div class="d-flex flex-wrap flex-column flex-sm-row">
            <picture class="flex-child">
                ...
                <img class="img-fluid" src="{{ asset('/media/renders/render-gare-cff-bex-p3-iubengineeringsa-2019@640.jpg') }}" alt='Rendu extérieur du point de vue 3 de la gare de Bex, projet réalisé par CFF SA + IUB Engineering SA'> {{--Compléter le chemin source @640x et texte alternatif--}}
            </picture>
            <picture class="flex-child">
                ...
                <img class="img-fluid" src="{{ asset('/media/renders/render-gare-cff-bex-p4-iubengineeringsa-2019@640.jpg') }}" alt='Rendu extérieur du point de vue 4 de la gare de Bex, projet réalisé par CFF SA + IUB Engineering SA'> {{--Compléter le chemin source @640x et texte alternatif--}}
            </picture>
        </div>
        <div class='legend'style="background-color: var(--light-brown);">
    ...
    <div id='amphipole' class='portfolio-bordered'> {{--Donner un id au projet--}}
        <div class="d-flex flex-wrap flex-column flex-sm-row">
            <picture class="flex-child">
                ...
                <img class="img-fluid" src="{{ asset('/media/renders/render-amphipole-unil-lausanne-exterieur-bartbuchhoferarchitektenag-2016@640.jpg') }}" alt='Rendu extérieur de l Amphipôle de l université de Lausanne, projet réalisé par Bart & Buchhofer Architekten AG'> {{--Compléter le chemin source @640x et texte alternatif--}}
            </picture>
            <picture class="flex-child">
                ...
                <img class="img-fluid" src="{{ asset('/media/renders/render-amphipole-unil-lausanne-interieur-bartbuchhoferarchitektenag-2016@640.jpg') }}" alt='Rendu intérieur de l Amphipôle de l université de Lausanne, projet réalisé par Bart & Buchhofer Architekten AG'> {{--Compléter le chemin source @640x et texte alternatif--}}
            </picture>
        </div>
        <div class='legend'style="background-color: var(--light-brown);">
    ...
    <div id='ambassade suisse' class='portfolio-bordered'> {{--Donner un id au projet--}}
        <div class="d-flex flex-wrap flex-column flex-sm-row">
            <picture class="flex-child">
                ...
                <img class="img-fluid" src="{{ asset('/media/renders/render-embassade-suisse-chine-exterieur-chappuisarchitectessa-2018@640.jpg') }}" alt='Rendu extérieur de l embassade de Suisse à Beijing en Chine, projet réalisé par Chappuis Architectes SA'> {{--Compléter le chemin source @640x et texte alternatif--}}
            </picture>
            <picture class="flex-child">
                ...
                <img class="img-fluid" src="{{ asset('/media/renders/render-embassade-suisse-chine-interieur-chappuisarchitectessa-2018@640.jpg') }}" alt='Rendu extérieur de l embassade de Suisse à Beijing en Chine, projet réalisé par Chappuis Architectes SA'> {{--Compléter le chemin source @640x et texte alternatif--}}
            </picture>
        </div>
        <div class='legend'style="background-color: var(--light-brown);">
    ...
    <div id='passerelle' class='portfolio-bordered'> {{--Donner un id au projet--}}
        <div class="d-flex flex-wrap flex-column flex-sm-row">
            <picture class="flex-child">
                ...
                <img class="img-fluid" src="{{ asset('/media/renders/render-passerelle-mobilite-douce-crissier-jour-mangeatwahlenarchitectes-2019@640.jpg') }}" alt='Rendu de jour de la passerelle mobilité douce à Crissier, projet réalisé par Mangeat Wahlen Architectes'> {{--Compléter le chemin source @640x et texte alternatif--}}
            </picture>
            <picture class="flex-child">
                ...
                <img class="img-fluid" src="{{ asset('/media/renders/render-passerelle-mobilite-douce-crissier-nuit-mangeatwahlenarchitectes-2019@640.jpg') }}" alt='Rendu de nuit de la passerelle mobilité douce à Crissier, projet réalisé par Mangeat Wahlen Architectes'> {{--Compléter le chemin source @640x et texte alternatif--}}
            </picture>
        </div>
        <div class='legend'style="background-color: var(--light-brown);">
