...
<div id='home-fullscreen' data-img="{{ URL::asset('/media/renders/20210126/196_Thun_BB_Ext@2560.jpg') }}" class="d-none d-sm-flex justify-content-center">
    @php
    ...
    <div id='dorfkern-ipsach' class='portfolio-bordered'> {{--Donner un id au projet--}}
        <div class="d-flex flex-wrap flex-column flex-sm-row">
            <picture class="flex-child">
                ...
                <img class="img-fluid" src="{{ asset('/media/renders/20210126/156_Ipsach_WR_Int@640.jpg') }}" alt='Rendu intérieur du projet Dorfkern à Ipsach, projet réalisé par ARGE Wahliruefli und Rollimarchini'> {{--Compléter le chemin source @640x et texte alternatif--}}
            </picture>
            <picture class="flex-child">
                ...
                <img class="img-fluid" src="{{ asset('/media/renders/20210126/156_Ipsach_WR_Ext@640.jpg') }}" alt='Rendu extérieur du projet Dorfkern à Ipsach, projet réalisé par ARGE Wahliruefli und Rollimarchini'> {{--Compléter le chemin source @640x et texte alternatif--}}
            </picture>
        </div>
        <div class='legend'style="background-color: var(--light-brown);">
    ...
    <div id='salle-de-sport-triple' class='portfolio-bordered'> {{--Donner un id au projet--}}
        <div class="d-flex flex-wrap flex-column flex-sm-row">
            <picture class="flex-child">
                ...
                <img class="img-fluid" src="{{ asset('/media/renders/20210126/172_Lac-Noir_Epure_Ext@640.jpg') }}" alt='Rendu extérieur de la salle de sport triple, projet réalisé par Epure Architecture et Urbanisme SA'> {{--Compléter le chemin source @640x et texte alternatif--}}
            </picture>
            <picture class="flex-child">
                ...
                <img class="img-fluid" src="{{ asset('/media/renders/20210126/172_Lac-Noir_Epure_Int@640.jpg') }}" alt='Rendu intérieur de la salle de sport triple, projet réalisé par Epure Architecture et Urbanisme SA'> {{--Compléter le chemin source @640x et texte alternatif--}}
            </picture>
        </div>
        <div class='legend'style="background-color: var(--light-brown);">
    ...
    <div id='allee-bruehl-mattenstrasse' class='portfolio-bordered'> {{--Donner un id au projet--}}
        <div class="d-flex flex-wrap flex-column flex-sm-row">
            <picture class="flex-child">
                ...
                <img class="img-fluid" src="{{ asset('/media/renders/20210126/155_Mattenstrasse_BB_Ext@640.jpg') }}" alt='Rendu extérieur du projet Allee-/ Brühl-/ Mattenstrasse à Bienne, projet réalisé par Bart & Buchhofer Architekten AG'> {{--Compléter le chemin source @640x et texte alternatif--}}
            </picture>
            <picture class="flex-child">
                ...
                <img class="img-fluid" src="{{ asset('/media/renders/20210126/155_Mattenstrasse_BB_Int@640.jpg') }}" alt='Rendu intérieur du projet Allee-/ Brühl-/ Mattenstrasse à Bienne, projet réalisé par Bart & Buchhofer Architekten AG'> {{--Compléter le chemin source @640x et texte alternatif--}}
            </picture>
        </div>
        <div class='legend'style="background-color: var(--light-brown);">
    ...
    <div id='bluefactory' class='portfolio-bordered'> {{--Donner un id au projet--}}
        <div class="d-flex flex-wrap flex-column flex-sm-row">
            <picture class="flex-child">
                ...
                <img class="img-fluid" src="{{ asset('/media/renders/20210126/119_Bluefactory_BBA_P4@640.jpg') }}" alt='Rendu de Blufactory à Fribourg, projet réalisé par BBA Archipole SA'> {{--Compléter le chemin source @640x et texte alternatif--}}
            </picture>
            <picture class="flex-child">
                ...
                <img class="img-fluid" src="{{ asset('/media/renders/20210126/119_Bluefactory_BBA_P6@640.jpg') }}" alt='Rendu de Blufactory à Fribourg, projet réalisé par BBA Archipole SA'> {{--Compléter le chemin source @640x et texte alternatif--}}
            </picture>
        </div>
        <div class="d-flex flex-wrap flex-column flex-sm-row">
            <picture class="flex-child">
                ...
                <img class="img-fluid" src="{{ asset('/media/renders/20210126/119_Bluefactory_BBA_P5@640.jpg') }}" alt='Rendu de Blufactory à Fribourg, projet réalisé par BBA Archipole SA'> {{--Compléter le chemin source @640x et texte alternatif--}}
            </picture>
            <picture class="flex-child">
                ...
                <img class="img-fluid" src="{{ asset('/media/renders/20210126/119_Bluefactory_BBA_P2@640.jpg') }}" alt='Rendu de Blufactory à Fribourg, projet réalisé par BBA Archipole SA'> {{--Compléter le chemin source @640x et texte alternatif--}}
            </picture>
        </div>
        <div class='legend'style="background-color: var(--light-brown);">
    ...
    <div id='poste-martigny' class='portfolio-bordered'> {{--Donner un id au projet--}}
        <div class="d-flex flex-wrap flex-column flex-sm-row">
            <picture class="flex-child">
                ...
                <img class="img-fluid" src="{{ asset('/media/renders/20210126/194_Martigny_dvarchitectes_Int_3@640.jpg') }}" alt='Rendu du bâtiment de la Poste à Martigny, projet réalisé par dvarchitectes & associés SA'> {{--Compléter le chemin source @640x et texte alternatif--}}
            </picture>
            <picture class="flex-child">
                ...
                <img class="img-fluid" src="{{ asset('/media/renders/20210126/194_Martigny_dvarchitectes_EXT@640.jpg') }}" alt='Rendu du bâtiment de la Poste à Martigny, projet réalisé par dvarchitectes & associés SA'> {{--Compléter le chemin source @640x et texte alternatif--}}
            </picture>
        </div>
        <div class="d-flex flex-wrap flex-column flex-sm-row">
            <picture class="flex-child">
                ...
                <img class="img-fluid" src="{{ asset('/media/renders/20210126/194_Martigny_dvarchitectes_Int_2@640.jpg') }}" alt='Rendu du bâtiment de la Poste à Martigny, projet réalisé par dvarchitectes & associés SA'> {{--Compléter le chemin source @640x et texte alternatif--}}
            </picture>
            <picture class="flex-child">
                ...
                <img class="img-fluid" src="{{ asset('/media/renders/20210126/194_Martigny_dvarchitectes_Int_1@640.jpg') }}" alt='Rendu du bâtiment de la Poste à Martigny, projet réalisé par dvarchitectes & associés SA'> {{--Compléter le chemin source @640x et texte alternatif--}}
            </picture>
        </div>
        <div class='legend'style="background-color: var(--light-brown);">
    ...
    <div id='centre-technique-et-logistique' class='portfolio-bordered'> {{--Donner un id au projet--}}
        <div class="d-flex flex-wrap flex-column flex-sm-row">
            <picture class="flex-child">
                ...
                <img class="img-fluid" src="{{ asset('/media/renders/20210126/198_Oiken_Epure_Int_1@640.jpg') }}" alt='Rendu intérieur 1 du centre technique et logistique de Sierre, projet réalisé par Epure Architecture et Urbanisme SA'> {{--Compléter le chemin source @640x et texte alternatif--}}
            </picture>
            <picture class="flex-child">
                ...
                <img class="img-fluid" src="{{ asset('/media/renders/20210126/198_Oiken_Epure_Int_2@640.jpg') }}" alt='Rendu intérieur 2 du centre technique et logistique de Sierre, projet réalisé par Epure Architecture et Urbanisme SA'> {{--Compléter le chemin source @640x et texte alternatif--}}
            </picture>
        </div>
        <div class='legend'style="background-color: var(--light-brown);">
